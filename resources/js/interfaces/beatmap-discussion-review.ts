...
export const beatmapReviewDiscussionTypes = [
  "praise",
  "problem",
  "suggestion",
] as const;

export type DocumentIssueEmbed =
  | NewDocumentIssueEmbed
  | PersistedDocumentIssueEmbed;
export type BeatmapReviewDiscussionType =
  (typeof beatmapReviewDiscussionTypes)[number];
...
export type PersistedBeatmapReviewBlock =
  | DocumentParagraph
  | PersistedDocumentIssueEmbed;
export type PersistedBeatmapDiscussionReview = PersistedBeatmapReviewBlock[];

export function isBeatmapReviewDiscussionType(
  type: string,
): type is BeatmapReviewDiscussionType {
