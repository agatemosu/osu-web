...
export default class DailyChallenge extends React.Component<Props> {
  ...
  render() {
    ...
    const userIsOnOwnProfile =
      this.props.stats.user_id === core.currentUser?.id;

    return (
      <div
        ref={this.valueRef}
        className={classWithModifiers("daily-challenge", {
          "played-today": playedToday && userIsOnOwnProfile,
        })}
